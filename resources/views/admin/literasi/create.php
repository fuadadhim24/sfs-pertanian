    ...
    <header class="header header-sticky mb-4">
        ...
        <div class="container-fluid"style="height:2px; font-size:11px">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb my-0 ms-2">
              ...
              <li class="breadcrumb-item"><span>Literasi</span></li>
              <li class="breadcrumb-item active"><span>Tambah Literasi</span></li>
            </ol>
          </nav>
        </div> 
      </header>
        <div class="body flex-grow-1 px-3">
            <div class="container-lg">
              <div class="card mb-4">
                <form action="../../../../app/Http/Controllers/literasi/createController.php" method="post" id="createLiterasi">
                  <div class="card-body">
                    <h5 class="card-title mb-4">Tambah Jenis Literasi</h5>
                    <nav>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                                  ...
                                  <div class="row g-3">
                                      <div class="col">
                                          ...
                                          <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="bentuk_kategori" id="bentuk_kategori" required>
                                            <option selected>Pilih bentuk kategori</option>
                                            <option value="konten_text">Konten(Text)</option>
                                            <option value="link_artikel_web/video/pdf">Link artikel web/ video/ pdf</option>
                                          </select>
                                      </div>
                                      ...
                                      <div class="col">
                                          ...
                                          <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="jenis" id="jenis" required>
                                            ...
                                            <option value="panduan_semai">Panduan Semai</option>
                                            <option value="panduan_pemupukan">Panduan Pemupukan</option>
                                            <option value="panduan_penyemprotan">Panduan Penyemprotan</option>
                                            <option value="penanggulangan_hama_penyakit">Penanggulangan Hama & Penyakit</option>
                                            <option value="panduan_panen">Panduan Panen</option>
                                          </select>
                                      </div>
                                  </div>
                              </div>
                      ...
                      <div class="tab-pane fade" id="nav-rincian" role="tabpanel" aria-labelledby="nav-rincian-tab" tabindex="0">
                          <div class="mb-3 mt-3">
                                  ...
                                  <input class="form-control" name="judul" id="judul" rows="3" required></input>
                              </div>
                          <div class="mb-3 mt-3">
                                  <label for="tanggal" class="form-label">Tanggal<span style="color:red"> *</span></label>
                                  <input class="form-control" name="tanggal" id="tanggal" rows="3" type="date" required></input>
                              </div>
                              <div class="mb-3">
                      ...
                      <div class="mt-2">
                              <button type="submit" id="createLiterasi" class="btn btn-success text-white" style="padding:8px; padding-right:40px; padding-left:40px; justify-content: center;align-items: center;">Tambah literasi</button>
                      </div>
                    </div>
                  </div>
                </form>
    ...
    <script>
      document.getElementById("createLiterasi").addEventListener("submit", function(event) {
          ...
          var formData = new FormData(this);
            ...
            fetch("../../../../app/Http/Controllers/literasi/createController.php", {
                method: "POST",
                body: formData,
            })
            .then((response) => {
