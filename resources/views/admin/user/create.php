    ...
    <header class="header header-sticky mb-4">
        ...
        <div class="container-fluid"style="height:2px; font-size:11px">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb my-0 ms-2">
              ...
              <li class="breadcrumb-item active"><span>Tambah Akun Petani</span></li>
            </ol>
          </nav>
        </div> 
      </header>
        <div class="body flex-grow-1 px-3">
            <div class="container-lg">
              <div class="card mb-4">
                <form action="../../../../app/Http/Controllers/user/createController.php" method="post" id="createBibit" enctype="multipart/form-data">
                  <div class="card-body">
                    <h5 class="card-title mb-4">Tambah Akun Petani</h5>
                    <nav>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                      <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab" tabindex="0">
                          <div class="row">
                              <div class="mb-3 mt-3">
                                  ...
                                  <input class="form-control" name="no_handphone" id="no_handphone" rows="3" required></input>
                                  <input class="form-control" type="hidden" name="hak_akses" id="hak_akses" rows="3" value="Petani"></input>
                              </div>
                              <div class="mb-3">
                                  <div class="row g-3">
                                      <div class="col">
                                          <label class="form-label">Nama Depan<span style="color:red"> *</span></label>
                                          <input class="form-control" name="nama_depan" id="nama_depan" rows="3" required></input>
                                      </div>
                                      <div class="col">
                                          <label class="form-label">Nama Belakang<span style="color:red"> *</span></label>
                                          <input class="form-control" name="nama_belakang" id="nama_belakang" rows="3" required></input>
                                      </div>
                                  </div>
                              </div>
                              <div class="mb-3 mt-3">
                                  <label class="form-label">Email<span style="color:red"> *</span></label>
                                  <input class="form-control" name="email" id="email" rows="3" required></input>
                              </div>
                              <div class="mb-3 mt-3">
                      ...
                      <div class="tab-pane fade" id="nav-rincian" role="tabpanel" aria-labelledby="nav-rincian-tab" tabindex="0">
                          <div class="mb-3 mt-3">
                                  <label for="id_bibit" class="form-label">Tanggal Lahir<span style="color:red"> *</span></label>
                                  <input type="date" class="form-control" name="tanggal_lahir" id="tanggal_lahir" rows="3" required></input>
                              </div>
                              <div class="mb-3">
                      ...
                      <div class="mt-2">
                              <button type="submit" id="createAkun" class="btn btn-success text-white" style="padding:8px; padding-right:40px; padding-left:40px; justify-content: center;align-items: center;">Tambah akun</button>
                      </div>
                    </div>
                  </div>
                </form>
    ...
    <script>
      document.getElementById("createBibit").addEventListener("submit", function(event) {
          ...
          var formData = new FormData(this);
            ...
            fetch("../../../../app/Http/Controllers/user/createController.php", {
                method: "POST",
                body: formData,
            })
            .then((response) => {
