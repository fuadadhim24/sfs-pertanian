                          ...
                          <div class="row">
                              ...
                              <div class="mb-3">
                                ...
                                <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="kategori" id="kategori" required>
                                  <option value="<?php echo $pupuk['kategori']; ?>" selected><?php echo $pupuk['kategori']; ?></option>
                          ...
                          <div class="mb-3 mt-3">
                              <div class="mb-3">
                                  ...
                                  <?php if (!empty($pupuk['gambar_path_main'])): ?>
                                    <img style="height:150px" src="../../../../public/assets/img/pupuk/<?php echo $pupuk['gambar_path_main']; ?>" alt="Gambar Utama" class="img-thumbnail">
                                  <?php endif; ?>
                              </div>
                              <div class="mb-3">
