                    ...
                    <div class="tab-content" id="nav-tabContent">
                      <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab" tabindex="0">
                          <div class="row">
                              ...
                              <div class="mb-3">
                                  <label class="form-label">Kategori Semprotan</label>
                                  <input type="hidden" class="form-control" name="kategori" id="kategori" rows="3" required></input>
                                  <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="kategori" id="kategori" required>
                                    <option selected disabled>Pilih jenis semprotan</option>
