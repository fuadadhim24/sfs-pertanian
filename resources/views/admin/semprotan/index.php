        ...
        <div class="container-fluid"style="height:2px; font-size:11px">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb my-0 ms-2">
              ...
              <li class="breadcrumb-item active"><span>Semprotan</span></li>
            </ol>
          </nav>
        </div> 
      </header>
          ...
          <div class="card mb-4">
            <div class="card-body">
              <div class="d-flex justify-content-between">
                <div>
                  <h4 class="card-title mb-0">Jenis Semprotan</h4>
                  <div class="small text-medium-emphasis">
                    UD Tani Rejo Jenggawah
                  </div>
                </div>
                <a href="./create.php"  class="btn btn-success text-white" style="margin-top:10px; justify-content: center;align-items: center;">Tambah Semprotan</a>
              </div>
              <div class="table-responsive" style="margin-top: 40px">
                <table class="table" style="width:1800px;">
                  ...
                  $no = 1;
                  $result = mysqli_query($conn, "SELECT * FROM semprotan");
                  while ($semprotan = mysqli_fetch_array($result)) {
                      echo "<tr>";
                      echo "<td>{$no}</td>";
                      ...
                      echo "<td style='text-align: justify'>{$semprotan['detail_semprotan']}</td>";
                      echo "<td>{$semprotan['deskripsi_singkat']}</td>";
                      if (!empty($semprotan['gambar_path_main'])) {
                        echo "<td style='text-align: center'>
                            <button style='padding-right:30px;padding-left:30px' type='button' class='btn btn-warning' onclick=\"window.open('../../../../public/assets/img/semprotan/{$semprotan['gambar_path_main']}', '_blank')\">
                      ...
                      if (!empty($semprotan['gambar_path_1'])) {
                        echo "<td style='text-align: center'>
                            <button style='padding-right:30px;padding-left:30px' type='button' class='btn btn-warning' onclick=\"window.open('../../../../public/assets/img/semprotan/{$semprotan['gambar_path_1']}', '_blank')\">
                                <img class='btn-logo' src='../../../../public/assets/icons/sent-icon.png'>
                            </img>
                            </button>
                        </td>";
                      ...
                      if (!empty($semprotan['gambar_path_2'])) {
                        echo "<td style='text-align: center'>
                            <button style='padding-right:30px;padding-left:30px' type='button' class='btn btn-warning' onclick=\"window.open('../../../../public/assets/img/semprotan/{$semprotan['gambar_path_2']}', '_blank')\">
                                <img class='btn-logo' src='../../../../public/assets/icons/sent-icon.png'>
                            </img>
                            </button>
                        </td>";
                      ...
                      if (!empty($semprotan['gambar_path_3'])) {
                        echo "<td style='text-align: center'>
                            <button style='padding-right:30px;padding-left:30px' type='button' class='btn btn-warning' onclick=\"window.open('../../../../public/assets/img/semprotan/{$semprotan['gambar_path_3']}', '_blank')\">
                                <img class='btn-logo' src='../../../../public/assets/icons/sent-icon.png'>
                            </img>
                            </button>
                        </td>";
                      ...
                      <td>
                        <div style='text-align: center'>
                              ...
                              <button style='margin-left: 0.5rem;'type='button' class='btn btn-danger' id='deleteBtn{$semprotan['id_semprotan']}' data-id='{$semprotan['id_semprotan']}'>
                                <img class='btn-logo' src='../../../../public/assets/icons/recycle-bin-line-icon.png'>
                                </img>
                              </button>
                              <button style='margin-right: 0.5rem; margin-left: 0.5rem;' type='button' class='btn btn-light' onclick=\"window.location.href='./edit.php?id={$semprotan['id_semprotan']}'\">
                                <img class='btn-logo' src='../../../../public/assets/icons/edit-pen-icon.png'>
                                </img>
                              </button>
                              <button type='button' class='btn btn-info' onclick=\"window.location.href='./info.php?id={$semprotan['id_semprotan']}'\">
              ...
              button.addEventListener('click', function () {
                  ...
                  Swal.fire({
                      ...
                      if (result.isConfirmed) {
                          ...
                          fetch(`../../../../app/Http/Controllers/semprotan/deleteController.php?id=${id}`, { method: 'GET' })
